...
CMD ["sh","-c","./node_modules/.bin/prisma migrate deploy && node apps/api/dist/scripts/bootstrap-admin.js && node apps/api/dist/scripts/sync-platform-defaults.js && node apps/api/dist/src/server.js"]
